...
namespace standard.master
{
	public class frmVehicle : Form
	{
        ...
        private BindingSource uspvehicleSelectResultBindingSource;
        ...
        private DataGridViewTextBoxColumn vh_number;
        private DataGridViewTextBoxColumn dataGridViewTextBoxColumn1;
        private DataGridViewTextBoxColumn vhudateDataGridViewTextBoxColumn;
        private DataGridViewTextBoxColumn vh_id;
		...
		private void LoadData()
		{
			...
			dgview.DataSource = inventoryDataContext.usp_vehicleSelect(null,txtSearch.Text);
            {
                txtVehicleNo.Focus();
            }
		...
		private void EditData()
		{
			if (dgview.CurrentCell != null)
			{
				...
				id = Convert.ToInt32(dgview["vh_id", rowIndex].Value);
                txtVehicleNo.Text = Convert.ToString(dgview["vh_number", rowIndex].Value);
                txtVehicleNo.Focus();
			}
		}
		...
		private void btnDelete_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					InventoryDataContext inventoryDataContext = new InventoryDataContext();
					inventoryDataContext.usp_vehicleDelete(id);
					Clear();
		...
		private void btnSave_Click(object sender, EventArgs e)
		{
			...
			{
				InventoryDataContext inventoryDataContext = new InventoryDataContext();
				vehicle at = new vehicle();
                at.vh_number = txtVehicleNo.Text.Trim();
                if (at.vh_number == string.Empty)
				{
					MessageBox.Show("Invalid 'Vehicle No.'", "Information", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
					txtVehicleNo.Focus();
				}
				else
				{
					var source = from b in inventoryDataContext.vehicles
						where b.vh_number == at.vh_number && b.vh_id != (long)id
						select new
						{
							b.vh_id
						};
					...
					else if (id == 0)
					{
						...
						{
							inventoryDataContext.usp_vehicleInsert(at.vh_number, global.ucode, global.sysdate);
					...
					{
						inventoryDataContext.usp_vehicleUpdate(id, at.vh_number, global.ucode, global.sysdate);
		...
		private void InitializeComponent()
		{
            ...
            this.uspvehicleSelectResultBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            this.vh_number = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.dataGridViewTextBoxColumn1 = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.vhudateDataGridViewTextBoxColumn = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.vh_id = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.a1Paneltitle.SuspendLayout();
            this.tblMain.SuspendLayout();
            this.tblSearch.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)(this.dgview)).BeginInit();
            ((System.ComponentModel.ISupportInitialize)(this.uspvehicleSelectResultBindingSource)).BeginInit();
            ...
            this.lblSearch.Size = new System.Drawing.Size(266, 28);
            this.lblSearch.TabIndex = 0;
            this.lblSearch.Text = "Search By Vehicle No.";
            ...
            this.vhudateDataGridViewTextBoxColumn,
            this.vh_id});
            this.dgview.Cursor = System.Windows.Forms.Cursors.Default;
            this.dgview.DataSource = this.uspvehicleSelectResultBindingSource;
            ...
            // 
            // uspvehicleSelectResultBindingSource
            // 
            this.uspvehicleSelectResultBindingSource.DataSource = typeof(standard.classes.usp_vehicleSelectResult);
            // 
            // tblEntry
            // 
            ...
            this.tblEntry.Controls.Add(this.lblCode, 0, 0);
            this.tblEntry.Controls.Add(this.txtVehicleNo, 1, 0);
            ...
            this.lblCode.Location = new System.Drawing.Point(3, 30);
            ...
            this.txtVehicleNo.Font = new System.Drawing.Font("Tahoma", 11F);
            this.txtVehicleNo.Location = new System.Drawing.Point(304, 27);
            this.txtVehicleNo.Name = "txtVehicleNo";
            this.txtVehicleNo.Size = new System.Drawing.Size(361, 34);
            this.txtVehicleNo.TabIndex = 4;
            this.txtVehicleNo.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtCode_KeyDown);
            // 
            // tblCommand
            // 
            ...
            // vh_number
            // 
            this.vh_number.DataPropertyName = "vh_number";
            this.vh_number.HeaderText = "Vehicle No.";
            this.vh_number.Name = "vh_number";
            this.vh_number.Width = 300;
            // 
            // dataGridViewTextBoxColumn1
            // 
            this.dataGridViewTextBoxColumn1.DataPropertyName = "users_uid";
            this.dataGridViewTextBoxColumn1.HeaderText = "users_uid";
            this.dataGridViewTextBoxColumn1.Name = "dataGridViewTextBoxColumn1";
            this.dataGridViewTextBoxColumn1.Visible = false;
            // 
            // vhudateDataGridViewTextBoxColumn
            // 
            this.vhudateDataGridViewTextBoxColumn.DataPropertyName = "vh_udate";
            this.vhudateDataGridViewTextBoxColumn.HeaderText = "vh_udate";
            this.vhudateDataGridViewTextBoxColumn.Name = "vhudateDataGridViewTextBoxColumn";
            this.vhudateDataGridViewTextBoxColumn.Visible = false;
            // 
            // vh_id
            // 
            this.vh_id.DataPropertyName = "vh_id";
            this.vh_id.HeaderText = "vh_id";
            this.vh_id.Name = "vh_id";
            this.vh_id.Visible = false;
            // 
            // frmVehicle
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.uspvehicleSelectResultBindingSource)).EndInit();
