...
namespace standard.trans
{
    public class frmSalesOrder : Form
    {
        ...
        private DataGridViewTextBoxColumn cSoID;
        private DataGridViewTextBoxColumn cComID;
            ...
            if (objsv.dgview.CurrentCell != null)
            {
                ...
                using (inventoryDataContext)
                {
                    ...
                    foreach (var item in queryable)
                    {
                        ...
                        dgvSales["cIsTaxable", r].Value = item.li.item_istaxable;
                        dgvSales["cComId", r].Value = item.li.com_id;
        ...
        private void cmdsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //if (id > 0)
                //{
                //    var existingOrder = inventoryDataContext.salesorders
                //                         .Where(x => x.so_id == id)
                //                         .Select(x => x.so_isclose)
                //                         .FirstOrDefault();

                //    if (existingOrder == true)
                //    {
                //        MessageBox.Show("This order is already converted to sales. Editing is not allowed.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                //        return;
                //    }
                //}
                    ...
                    if (MessageBox.Show("Are you sure to save?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) != DialogResult.No)
                    {
                        ...
                        if (id == 0)
                        {
                            ...
                            foreach (DataGridViewRow item2 in (IEnumerable)dgvSales.Rows)
                            {
                                if (!item2.IsNewRow)
                                {
                                    salesorderdetail.item_id = Convert.ToInt32(item2.Cells["cItemID"].Value);
                                    salesorderdetail.od_qty = Convert.ToInt32(item2.Cells["cQty"].Value);
                                    salesorderdetail.od_unitvalue = Convert.ToDecimal(item2.Cells["cUnitValue"].Value);
                                    ...
                                    salesorderdetail.com_id = Convert.ToInt32(item2.Cells["cComID"].Value);
                                    salesorderdetail.od_istaxable = Convert.ToBoolean(item2.Cells["cIsTaxable"].Value);
                                    ...
                                    var pendingDetail = (from sod in inventoryDataContext.salesorderdetails
                                                         ...
                                                         join itm in inventoryDataContext.items on sod.item_id equals itm.item_id
                                                         where so.led_id == salesorder.led_id &&
                                                               sod.item_id == salesorderdetail.item_id &&
                                                               sod.od_pendingqty > 0
                                                         select new { sod, so, itm.cat_id }).FirstOrDefault();
                                    ...
                                    if (pendingDetail != null)
                                    {
                                        ...
                                        inventoryDataContext.usp_salesorderdetailsUpdate(pendingDetail.sod.od_id,
                                            ...
                                            pendingDetail.sod.od_unitvalue,
                                            newSoldQty,
                                            newPendingQty,
                                            pendingDetail.sod.od_rate,
                                            pendingDetail.sod.com_id,
                                            pendingDetail.sod.od_istaxable
                                        );
                        ...
                        else
                        {
                            ...
                            if (oldrecord != null && oldrecord.so_isclose == true)
                            {
                                ...
                                // 🔁 Call update for each detail also
        ...
        private void ConvertSalesOrder(int sdId, bool showMessage = true)
        {
            ...
            if (com2list.Count > 0 && com2.com_id == 2)
            {
                ...
                foreach (var com2SOD in com2list)
                {
                    ...
                    salesorderdetail.com_id = com2SOD.com_id;
                    salesorderdetail.od_istaxable = com2SOD.od_istaxable;
                    salesdetail.sd_rate = Convert.ToDecimal(com2SOD.od_rate * com2SOD.item_quantity);

                    if (com2SOD.cat_id == 39)
                    {
                        salesorderdetail.od_pendingqty = com2SOD.od_unitvalue;
                    }
                    else
                    {
                        salesorderdetail.od_pendingqty = com2SOD.od_qty;
                    }
                    ...
                    inventoryDataContext.usp_salesorderdetailsUpdate(com2SOD.od_id, com2SOD.so_id, com2SOD.item_id, com2SOD.od_qty, com2SOD.od_unitvalue, 0, salesorderdetail.od_pendingqty, com2SOD.od_rate, com2SOD.com_id, com2SOD.od_istaxable);
        ...
        private void loadlist()
        {
            ...
            foreach (usp_salesorderdetailsSelectResult item in singleResult2)
            {
                ...
                dgvSales["cOdID", dgvSales.RowCount - 1].Value = item.od_id;
                dgvSales["cItemID", dgvSales.RowCount - 1].Value = item.item_id;
                dgvSales["cComId", dgvSales.RowCount - 1].Value = item.com_id;
                dgvSales["csoId", dgvSales.RowCount - 1].Value = item.so_id;
                ...
                dgvSales["cUnitValue", dgvSales.RowCount - 1].Value = item.od_unitvalue;
            ...
            tablemain.BringToFront();
            cboissueto.Focus();
            var order = inventoryDataContext.salesorders.FirstOrDefault(so => so.so_id == num);
            if (order != null)
            {
                so_isclose = order.so_isclose ?? false;// Assuming this is the column in DB
                dgvSales.ReadOnly = so_isclose;

                if (so_isclose)
                {
                    MessageBox.Show("Sales order is already closed. You cannot edit it.", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
        }
            ...
            if (e.KeyCode == Keys.Return || e.KeyCode == Keys.Tab)
            {
                ...
                if (pendingItems.Any())
                {
                    ...
                    foreach (var item in pendingItems)
                    {
                        ...
                        dgvSales.Rows[rowIndex].Cells["cItemID"].Value = item.item.item_id;
                        dgvSales.Rows[rowIndex].Cells["cUnitValue"].Value = item.od_unitvalue;
                        dgvSales.Rows[rowIndex].Cells["cQty"].Value = item.od_pendingqty;
                        dgvSales.Rows[rowIndex].Cells["cIsTaxable"].Value = item.od_istaxable;
                        decimal qty = 0;
                        ...
                        if (item.cat_id == 39)
                        {
                            dgvSales.Rows[rowIndex].Cells["cUnitValue"].Value = item.od_pendingqty;
                            dgvSales.Rows[rowIndex].Cells["cQty"].Value = 1;
                        }
        ...
        bool so_isclose = false;
        private void dgvSales_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            if (so_isclose)
            {
                MessageBox.Show("This sales order is closed and cannot be modified.", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                dgvSales.CancelEdit();
                return;
            }
                    ...
                    try
                    {
                        ...
                        using (inventoryDataContext3)
                        {
                            ...
                            if (item2 != null)
                            {
                                ...
                                dgvSales["cComID", r].Value = item2.li.com_id;
                                ...
                                if (dgvSales["cCatID", r].Value != null && Convert.ToInt32(dgvSales["cCatID", r].Value) == 52)
                                {
                                    dgvSales["cUnitValue", r].Value = 1;
                                }
                                decimal amount = 0;
                ...
                try
                {
                    ...
                    using (inventoryDataContext)
                    {
                        ...
                        foreach (var item4 in queryable2)
                        {
                            ...
                            dgvSales["cComID", r].Value = item4.li.com_id;
                            ...
                            if (lblRateType.Text.ToUpper() == "MRP  (D)")
                            {
                                amount = item4.li.item_mrp / item4.li.item_quantity;
                            }
                            else if (lblRateType.Text.ToUpper() == "WHOLE SALE RATE  (C)")
                            {
                                amount = item4.li.item_wholesalerate / item4.li.item_quantity;
                            }
                            else if (lblRateType.Text.ToUpper() == "SPECIAL RATE  (B)")
                            {
                                amount = item4.li.item_specialrate / item4.li.item_quantity;
                            }
                            else if (lblRateType.Text.ToUpper() == "SUPER SPECIAL RATE  (A)")
                            {
                                amount = item4.li.item_supersepecialrate / item4.li.item_quantity;
                            }
        ...
        private void InitializeComponent()
        {
            ...
            this.cSoID = new System.Windows.Forms.DataGridViewTextBoxColumn();
            ...
            this.chkIsFrieght.Size = new System.Drawing.Size(385, 37);
            ...
            this.lblopno.Location = new System.Drawing.Point(5, 7);
            this.lblopno.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
            this.lblopno.Name = "lblopno";
            this.lblopno.Size = new System.Drawing.Size(91, 29);
            ...
            this.lbldate.Location = new System.Drawing.Point(5, 50);
            ...
            this.dtpsaldate.Size = new System.Drawing.Size(193, 36);
            ...
            this.txtopno.Size = new System.Drawing.Size(193, 36);
            ...
            this.lblRateType.Location = new System.Drawing.Point(335, 50);
            this.lblRateType.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
            this.lblRateType.Name = "lblRateType";
            this.lblRateType.Size = new System.Drawing.Size(21, 29);
            ...
            this.lblAddress.Location = new System.Drawing.Point(610, 50);
            this.lblAddress.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
            this.lblAddress.Name = "lblAddress";
            this.lblAddress.Size = new System.Drawing.Size(21, 29);
            ...
            this.label2.Location = new System.Drawing.Point(902, 7);
            ...
            this.cboCity.Size = new System.Drawing.Size(166, 37);
            ...
            this.lblfrom.Location = new System.Drawing.Point(435, 7);
            this.lblfrom.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
            this.lblfrom.Name = "lblfrom";
            this.lblfrom.Size = new System.Drawing.Size(128, 29);
            ...
            this.cboissueto.Size = new System.Drawing.Size(261, 37);
            ...
            this.lblGSTIN.Location = new System.Drawing.Point(5, 8);
            this.lblGSTIN.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
            this.lblGSTIN.Name = "lblGSTIN";
            this.lblGSTIN.Size = new System.Drawing.Size(21, 29);
            ...
            this.lbltotqty.Location = new System.Drawing.Point(5, 7);
            this.lbltotqty.Margin = new System.Windows.Forms.Padding(5, 0, 5, 0);
            this.lbltotqty.Name = "lbltotqty";
            this.lbltotqty.Size = new System.Drawing.Size(74, 29);
            ...
            this.txttotqty.Size = new System.Drawing.Size(100, 36);
            ...
            // cSoID
            // 
            this.cSoID.HeaderText = "SoID";
            this.cSoID.MinimumWidth = 6;
            this.cSoID.Name = "cSoID";
            this.cSoID.Visible = false;
            this.cSoID.Width = 125;
            // 
            // cComID
            // 
            this.cComID.HeaderText = "ComID";
            this.cComID.MinimumWidth = 6;
            this.cComID.Name = "cComID";
            this.cComID.Visible = false;
            this.cComID.Width = 125;
            // 
            // cOdID
            // 
            this.cOdID.HeaderText = "ODID";
            this.cOdID.MinimumWidth = 6;
            this.cOdID.Name = "cOdID";
            this.cOdID.Visible = false;
            this.cOdID.Width = 125;
            // 
            // cCategory
            // 
            ...
            this.CPendingQty.MinimumWidth = 6;
            ...
            this.cTaxPercentage.MinimumWidth = 6;
            ...
            this.cTaxAmount.MinimumWidth = 6;
            ...
            this.cCostAmount.MinimumWidth = 6;
            ...
            dataGridViewCellStyle12.Font = new System.Drawing.Font("Tahoma", 15.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            dataGridViewCellStyle12.ForeColor = System.Drawing.SystemColors.WindowText;
            dataGridViewCellStyle12.SelectionBackColor = System.Drawing.SystemColors.Highlight;
            dataGridViewCellStyle12.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
            dataGridViewCellStyle12.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
            this.dglist.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle12;
            ...
            this.soidDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.soidDataGridViewTextBoxColumn.Width = 125;
            // 
            ...
            this.sorefnoDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.sodateDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle13;
            this.sodateDataGridViewTextBoxColumn.HeaderText = "Bill Date";
            this.sodateDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.lednameDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.sototqtyDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle14;
            this.sototqtyDataGridViewTextBoxColumn.HeaderText = "Total Qty";
            this.sototqtyDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.sostatusDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.ledidDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.ledidDataGridViewTextBoxColumn.Width = 125;
            // 
            ...
            this.smudateDataGridViewTextBoxColumn.MinimumWidth = 6;
            ...
            this.smudateDataGridViewTextBoxColumn.Width = 125;
            // 
            ...
            this.dtptdate.Location = new System.Drawing.Point(274, 6);
            this.dtptdate.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
            this.dtptdate.Name = "dtptdate";
            this.dtptdate.Size = new System.Drawing.Size(159, 39);
            ...
            this.lblfdate.Size = new System.Drawing.Size(62, 52);
            ...
            this.dtpfdate.Location = new System.Drawing.Point(78, 6);
            this.dtpfdate.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
            this.dtpfdate.Name = "dtpfdate";
            this.dtpfdate.Size = new System.Drawing.Size(168, 39);
            ...
            this.lblhyp.Location = new System.Drawing.Point(254, 9);
            this.lblhyp.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.lblhyp.Name = "lblhyp";
            this.lblhyp.Size = new System.Drawing.Size(12, 33);
            ...
            this.label6.Size = new System.Drawing.Size(118, 52);
            ...
            this.lblBillNo.Location = new System.Drawing.Point(638, 61);
            this.lblBillNo.Margin = new System.Windows.Forms.Padding(4, 0, 4, 0);
            this.lblBillNo.Name = "lblBillNo";
            this.lblBillNo.Size = new System.Drawing.Size(96, 33);
            ...
            this.txtSearchBillNo.Location = new System.Drawing.Point(741, 58);
            this.txtSearchBillNo.Name = "txtSearchBillNo";
            this.txtSearchBillNo.Size = new System.Drawing.Size(123, 39);
