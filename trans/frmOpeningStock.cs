...
{
    public class frmOpeningStock : Form
    {
        ...
        private BindingSource uspStockSelectResultBindingSource;
        ...
        private DataGridViewTextBoxColumn stidDataGridViewTextBoxColumn;
        ...
        private DataGridViewTextBoxColumn stqtyDataGridViewTextBoxColumn;

        private DataGridViewTextBoxColumn stdateDataGridViewTextBoxColumn;
        ...
        private void LoadData()
        {
            ...
            using (inventoryDataContext)
            {
                var source = from a in inventoryDataContext.stocks
                             join it in inventoryDataContext.items on a.item_id equals it.item_id
                             where a.stockfrom == "OPENING"
                             select new
                             {
                                 a.id,
                                 a.stock_addqty,
                                 ...
                                 item_qty = it.item_quantity,
                                 item_unit = it.item_unit
                             };
                uspStockSelectResultBindingSource.DataSource = source.OrderBy(x => x.id);
                long? no = 0L;
        ...
        private void cmdsave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    DateTime stockDate;
                    if (DateTime.TryParse(dtpsaldate.Text, out stockDate))
                    {
                    ...
                    if (id == 0)
                    {
                        foreach (DataGridViewRow item2 in (IEnumerable)dgvSales.Rows)
                        {
                            ...
                            {
                                long? no = 0L;
                                stock.item_id = Convert.ToInt32(item2.Cells["cItemID"].Value);
                                stock.com_id = Convert.ToInt32(item2.Cells["cComId"].Value);
                                stock.stock_addqty = Convert.ToDecimal(item2.Cells["cQty"].Value);
                                inventoryDataContext.usp_stockInsert(0, "OPENING", stock.item_id, stock.com_id, stock.stock_addqty, 0, stock.stock_date);
                            }
                        }
                    }
        ...
        private void cmdprint_Click(object sender, EventArgs e)
        {
            ...
            {
                InventoryDataContext inventoryDataContext = new InventoryDataContext();
                var stockList = inventoryDataContext.usp_openingStockSelect(null, null, dtpfdate.Value.Date, dtptdate.Value.Date, "OPENING");
                var itemList = inventoryDataContext.items.ToList();
                var displayList = from stock in stockList
                                  join item in itemList on stock.item_id equals item.item_id
                                  select new
                                  {
                                      stock.stock_date,                                     
                                      item.item_name,
                ...
                dglist.DataSource = displayList.ToList();
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)(this.uspStockSelectResultBindingSource)).BeginInit();
            ...
            this.tableentry.Controls.Add(this.txtopno, 2, 0);
            this.tableentry.Controls.Add(this.lblopno, 5, 0);
            this.tableentry.Controls.Add(this.lbldate, 0, 0);
            this.tableentry.Controls.Add(this.dtpsaldate, 1, 0);
            ...
            this.lblRateType.Visible = false;
            // 
            // lblAddress
            // 
            ...
            this.txtopno.Location = new System.Drawing.Point(335, 7);
            ...
            this.tablecmd.Controls.Add(this.cmdrefresh, 3, 0);
            this.tablecmd.Controls.Add(this.cmdview, 2, 0);
            ...
            this.cmdrefresh.Location = new System.Drawing.Point(1389, 7);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.uspStockSelectResultBindingSource)).EndInit();
