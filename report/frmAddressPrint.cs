...
namespace standard.report
{
    public partial class frmAddressPrint : Form
    {
        ...
        private void LoadData()
        {
            ...
            using (db)
            {
                ledgermasterBindingSource.DataSource = db.usp_ledgermasterSelect(null, null, null, null, null, null, null);
                cboName.SelectedValue = 0;

                var cusdata = db.usp_ledgermasterSelect(null, null, null, null, null, null, null);
        ...
        private void DirectLoadReport()
        {
            ...
            using (db)
            {
                ...
                var data = db.usp_ledgermasterSelect(ledgerID, null, null, null, null,null, null);
        ...
        private void LoadReport()
        {
            ...
            using (db)
            {
                ...
                var data = db.usp_ledgermasterSelect(id, null, null, null, null, null, null);
                if(_isCoverPrint==true)
                {
                    if(_isWithGst==true)
                    {
